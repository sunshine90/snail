 ...
 *
 * If arguments are passed, they are proxied to either [Connection#open](#connection_Connection-open) or [Connection#openSet](#connection_Connection-openSet) appropriately. This means we can pass `db`, `server`, and `replset` options to the driver. _Note that the `safe` option specified in your schemas will overwrite the `safe` db option specified here unless you set your schemas `safe` option to `undefined`. See [this](/docs/guide.html#safe) for more information._
 *
 ...
 * ####Example:
 *
 *     var schemas = new Schema({ name: String }, { collection: 'actor' });
 *
 *     // or
 *
 *     schemas.set('collection', 'actor');
 *
 *     // or
 *
 *     var collectionName = 'actor'
 *     var M = mongoose.model('Actor', schemas, collectionName)
 *
...
Mongoose.prototype.model = function (name, schema, collection, skipInit) {
  ...
  // look up schemas for the collection.
  ...
  // connection.model() may be passing a different schemas for
  ...
  // Apply relevant "global" options to the schemas
...
/**
 * Applies global plugins to `schemas`.
 *
 * @param {Schema} schema
 * @api private
 */
