 ...
 *
 *     // expire in 7 days
 *     var schemas = new Schema({ createdAt: Date });
 *     schemas.path('createdAt').expires('7d');
 *
 ...
 *     var schemas = new Schema({ d: { type: Date, min: min })
 *     var M = mongoose.model('M', schemas);
 ...
 *     var schemas = new Schema({ d: { type: Date, max: max })
 *     var M = mongoose.model('M', schemas);
