...
/**
 * This schemas type's name, to defend against minifiers that mangle
 * function names.
 *
 * @api private
 */
 ...
 * ####Example:
 *
 *     var schemas = new Schema({ postalCode: { type: String, minlength: 5 })
 *     var Address = db.model('Address', schemas)
 ...
 *     var schemas = new Schema({ postalCode: { type: String, minlength: minlength })
 *     var Address = mongoose.model('Address', schemas);
 *     var address = new Address({ postalCode: '9512' });
 ...
 * ####Example:
 *
 *     var schemas = new Schema({ postalCode: { type: String, maxlength: 9 })
 *     var Address = db.model('Address', schemas)
 ...
 *     var schemas = new Schema({ postalCode: { type: String, maxlength: maxlength })
 *     var Address = mongoose.model('Address', schemas);
 *     var address = new Address({ postalCode: '9512512345' });
